...
public class finalizeOrderForm extends JFrame {
    ...
    public finalizeOrderForm() {
        ...
        btnFinalizeOrder.addActionListener(e -> {
            ...
            int check = JOptionPane.showConfirmDialog(null, "Are you sure you want to notify the Customer?", "Warning", JOptionPane.YES_NO_OPTION);
